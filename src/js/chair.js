var xmlhttp;
var site_url="http://localhost/basmic/system/application/views/chair/peer2/";
...
/*
function RoleChangeds(usremail,confid,role)
{
...
url=url+"?usremail="+usremail;
url=url+"&confno="+confid;
url=url+"&role="+role;
url=url+"&sid="+Math.random();
xmlhttp.onreadystatechange=RoleChangedChange;
xmlhttp.open("GET",url,true);
xmlhttp.send(null);
}

function RoleChangedChange()
{
if (xmlhttp.readyState==4)
  {document.getElementById("Roles").innerHTML=xmlhttp.responseText;}
}
*/
/* -------------------------   Updated Code --------------------------*/

function UserManagement(confid)
{
xmlhttp=GetXmlHttpObject();
if (xmlhttp==null)
  {
...
url=url+"&sid="+Math.random();
xmlhttp.onreadystatechange=UserManChange;
xmlhttp.open("GET",url,true);
xmlhttp.send(null);
}

function UserManChange()
{
if (xmlhttp.readyState==4)
  {
...
if (xmlhttp.readyState==4)
  {
  document.getElementById("breaknews").innerHTML=xmlhttp.responseText;
  }
}
/* ------------------------- [\]  Updated Code --------------------------*/
...
var url=site_url+"manualpaper.php";
url=url+"?ShowReview="+conf;
url=url+"&sid="+Math.random();
xmlhttp.onreadystatechange=ShowReviewChanged;
xmlhttp.open("GET",url,true);
xmlhttp.send(null);
}

function ShowReviewChanged()
{
	if (xmlhttp.readyState==4)
	{document.getElementById("detail").innerHTML=xmlhttp.responseText;}
}
