...
<body id="page" class="font-small width-wide layoutleft lightblue">	
	...
	<div id="page-body">
		...
		<a href="<?php echo $base_url; ?>index.php/ca/" title="Home">
		<span id="logo" class="correct-png"></span></a>								
			...
			echo " Welcome, ".$email;
			echo "<table align='right'><tr><td><b>".anchor('ca/conf_reg','Register a Conference')."</b></td></tr></table>";	
			}
			else
			{
			//echo anchor('home/profile', 'Profile | ');			 
					...
					<div id="left_container" class="clearingfix">
						<div class="left-m">
							<div class="left-t">
								...
								<a href="<?php echo $base_url; ?>index.php/ca/" class="level1 item1 first last active current">
								<span>Home</span></a></li>
<?php  
...
{ 								
	...
	echo '<a href="'.$base_url.'index.php/ca/profile" class="level1 item1 first last active current">';
	echo '<span>Profile</span></a></li>';
	
	//echo '<li class="level1 item1 first last active current">';
	//echo '<a href="'.$base_url.'index.php/ca/user" class="level1 item1 first last active current">';
	//echo '<span>User Management</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/ca/paper" class="level1 item1 first last active current">';
	echo '<span>Paper Management</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/ca/reviewer" class="level1 item1 first last active current">';
	echo '<span>Reviewer Management</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/ca/att_reg" class="level1 item1 first last active current">';
	echo '<span>Attend Conference</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/ca/history" class="level1 item1 first last active current">';
	echo '<span>History</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/ca/logout" class="level1 item1 first last active current">';
...
else
{
	...
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/ca/register" class="level1 item1 first last active current">';
	...
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/ca/login" class="level1 item1 first last active current">';
