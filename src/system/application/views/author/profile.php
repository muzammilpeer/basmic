...
$j=1;
foreach ($p as $value => $list)
{
	if ($j == 1){echo "<tr><td>Accepted Papers: </td><td>".$list."</td></tr>"; $j+=1;}
	else if ($j == 2){echo "<tr><td>Rejected Papers: </td><td>".$list."</td></tr>"; $j+=1;}
}
echo "</table>";
...
echo "<td><center>".anchor('author/change_password', 'Change Password')."</center></td></tr>"; 
echo "<tr><td><img src='".$base_url."images/File edit.png'>"."</td>";
echo "<td><center>".anchor('author/edit_profile', 'Edit Profile')."</center></td></tr>"; 
echo "</table>";
