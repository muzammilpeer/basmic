...
<?php $base = "http://localhost/basmic/"; ?>
  ...
  <script type="text/javascript" src="<?php echo $base; ?>/js/author.js"></script>
  <script type="text/javascript" src="<?php echo $base; ?>/js/uploader.js"></script>
...
<body id="page" class="font-small width-wide layoutleft lightblue">	
	...
	<div id="page-body">
		...
		<a href="<?php echo $base_url; ?>index.php/author/status.html" title="Home">
		<span id="logo" class="correct-png"></span></a>								
			...
			if ($status)
			{ 
			//echo anchor('rev/profile', 'Profile | ');
			//echo anchor('rev/logout', 'Logout'); 
			$email = $this->session->userdata('email');
			echo " Welcome, ".$email;
			echo "<table align='right'><tr><td><b>".anchor('author/conf_reg','Register a Conference')."</b></td></tr></table>";	
			}
			else
			{
			//echo anchor('rev/profile', 'Profile | ');			 
			//echo anchor('rev/register', 'Register | ');
			//echo anchor('rev/login', 'Login');	
			echo "<table align='right'><tr><td><b>".anchor('author/conf_reg','Register a Conference')."</b></td></tr></table>";		
			}			
			?>
			</div>
					...
					<div id="left_container" class="clearingfix">
						<div class="left-m">
							<div class="left-t">
								...
								<a href="<?php echo $base_url; ?>index.php/author/status.html" class="level1 item1 first last active current">
								<span>Home</span></a></li>
<?php  
...
{ 								
	...
	echo '<a href="'.$base_url.'index.php/author/profile" class="level1 item1 first last active current">';
	echo '<span>Profile</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/author/upload" class="level1 item1 first last active current">';
	echo '<span>Submit Paper</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/author/my_papers" class="level1 item1 first last active current">';
	echo '<span>History</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/author/att_reg" class="level1 item1 first last active current">';
	echo '<span>Attend Conference</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/author/logout" class="level1 item1 first last active current">';
	echo '<span>Logout</span></a></li>';
}
else
{
	//echo '<li class="level1 item1 first last active current">';
	//echo '<a href="'.$base_url.'index.php/rev/profile" class="level1 item1 first last active current">';
	//echo '<span>Profile</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/author/register" class="level1 item1 first last active current">';
	...
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/author/login" class="level1 item1 first last active current">';
