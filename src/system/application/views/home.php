...
<?php $base = "http://localhost/basmic/"; ?>
  ...
  <meta name="description" content="BASMIC - the Pakistani Conference Management System">
...
<body id="page" class="font-small width-wide layoutleft lightblue">	
	...
	<div id="page-body">
		...
		<span id="logo" class="correct-png"></span></a>								
			...
			echo " Welcome, ".$email;
			echo "<table align='right'><tr><td><b>".anchor('home/conf_reg','Register a Conference')."</b></td></tr></table>";	
			}
			else
			{
			//echo anchor('home/profile', 'Profile | ');			 
					...
					<div id="left_container" class="clearingfix">
						<div class="left-m">
							<div class="left-t">
								...
								<a href="<?php echo $base_url; ?>" class="level1 item1 first last active current">
								<span>Home</span></a></li>
<?php  
...
{ 								
	...
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/home/logout" class="level1 item1 first last active current">';
...
else
{
	...
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/home/register" class="level1 item1 first last active current">';
	...
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/home/login" class="level1 item1 first last active current">';
