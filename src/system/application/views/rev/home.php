...
<?php $base = "http://localhost/basmic/"; ?>
  ...
  <script type="text/javascript" src="<?php echo $base; ?>/js/reviewer.js"></script>
...
<body id="page" class="font-small width-wide layoutleft lightblue">	
	...
	<div id="page-body">
		...
		<a href="<?php echo $base_url; ?>index.php/rev/status.html" title="Home">
		<span id="logo" class="correct-png"></span></a>								
			...
			echo " Welcome, ".$email;
			echo "<table align='right'><tr><td><b>".anchor('rev/conf_reg','Register a Conference')."</b></td></tr></table>";	
			}
			else
			{
			//echo anchor('rev/profile', 'Profile | ');			 
					...
					<div id="left_container" class="clearingfix">
						<div class="left-m">
							<div class="left-t">
								...
								<a href="<?php echo $base_url; ?>index.php/rev/status.html" class="level1 item1 first last active current">
								<span>Home</span></a></li>
<?php  
...
{ 								
	...
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/rev/list_papers" class="level1 item1 first last active current">';
	echo '<span>Assigned Papers</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/rev/rate_paper" class="level1 item1 first last active current">';
	echo '<span>Rate Papers</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/rev/att_reg" class="level1 item1 first last active current">';
	echo '<span>Attend Conference</span></a></li>';
	
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/rev/logout" class="level1 item1 first last active current">';
...
else
{
	...
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/rev/register" class="level1 item1 first last active current">';
	...
	echo '<li class="level1 item1 first last active current">';
	echo '<a href="'.$base_url.'index.php/rev/login" class="level1 item1 first last active current">';
